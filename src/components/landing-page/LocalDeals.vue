<template>
  ...
  <!-- <div style="margin: 2rem 4rem;"> -->
    <h1 class="text-center my-4 font-bold" style="font-size: 1.5rem;">Local Deals</h1>
    ...
    <v-hover style="position: relative">
      <div class="items-container">
        <!-- Left Chevron (visible only when hovering) -->
          ...
          icon
          @click="scrollLeft"
          style="position: absolute; top: 8rem; left: 0; z-index: 2; color: #EC6A04;"
          x-large
        >
          ...
          icon
          @click="scrollRight"
          style="position: absolute; top: 8rem; right: 0; z-index: 2; color: #EC6A04;"
          x-large
        >
        ...
        <div style="min-width: 15rem;" v-for="deal in deals"
            :key="deal.id">
       <v-card
              flat
              outlined
            ...
            <v-btn class="more" @click="navigate('/local')" fab>
  ...
  methods: {
    async getItems() {
      ...
      try {
          ...
          "https://lendnode.creditclan.com/gateway/store/stores/get_nigeria_deals/nigeria",
          { search: "", page: 1, is_deals: 1, }
        );
